...
from connect_4.strategy import Strategy, opponentOf, performMove, checkIfGameOver, isValidMove, copyOfBoard

YELLOW_COLOR = "\u001b[38;5;226m"  
RED_COLOR = '\033[91m'             
BLUE_COLOR = "\u001b[38;5;39m"     
GREEN_COLOR = "\x1B[38;5;47m"      
GREY_COLOR = "\x1B[38;5;247m"      
NO_COLOR = '\033[0m'               
...
SAVE_FILENAME = "connect4_saved_game.txt"
BOARD_HISTORY = [] 

EMPTY, RED, YELLOW = '.', 'o', '@'
gameBoard = [[EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY],  
...
def main():
    ...
    if not useSavedGame:
        print("AI constants are modifiable in the strategy.py file. (Developer Only)")
